...
The **Cisco ACI Ports Autoload 2G** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|CiscoAciPortsAutoload.zip|Cisco ACI Ports Autoload shell package|
|cisco-aci-ports-autoload-offline-dependecies-1.0.0.zip|Shell Python dependencies (for offline deployments only)|
...
1. Download the *cisco-aci-ports-autoload-offline-dependecies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  5. In the **Resource** dialog box, enter the device's settings, see [Cisco ACI Ports Autoload 2G Shell Attributes](#cisco-aci-ports-autoload-2g-shell-attributes).
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/Cisco-ACI-Ports-Autoload-Shell-2G/releases).
